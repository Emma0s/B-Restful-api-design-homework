...
public class GroupData {
    ...
    private static void initGroups() {
        ...
        GroupsDTO groupsDTO2 = new GroupsDTO(1, "team2", "", team2Student);
        List<StudentDTO> team3Student = new ArrayList<>();
        GroupsDTO groupsDTO3 = new GroupsDTO(2, "team3", "", team3Student);
        List<StudentDTO> team4Student = new ArrayList<>();
        GroupsDTO groupsDTO4 = new GroupsDTO(3, "team4", "", team4Student);
        List<StudentDTO> team5Student = new ArrayList<>();
        GroupsDTO groupsDTO5 = new GroupsDTO(4, "team5", "", team5Student);
        List<StudentDTO> team6Student = new ArrayList<>();
        GroupsDTO groupsDTO6 = new GroupsDTO(5, "team6", "", team6Student);
    ...
    public GroupsDTO updateGroupsName(Integer groupId, String groupName) {
        if (!isInitialed) initGroups();
        groupsDTOList.get(groupId).setName(groupName);
        return groupsDTOList.get(groupId);
    }
}
